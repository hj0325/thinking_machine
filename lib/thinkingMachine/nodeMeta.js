...
export const SUGGESTION_TAG_META = {
  reasoning: {
    Insight: { className: "bg-violet-100 text-violet-700" },
    Problem: { className: "bg-rose-100 text-rose-700" },
    Constraint: { className: "bg-slate-100 text-slate-700" },
    Decision: { className: "bg-teal-100 text-teal-700" },
    Idea: { className: "bg-emerald-100 text-emerald-700" },
    Action: { className: "bg-cyan-100 text-cyan-700" },
    Risk: { className: "bg-pink-100 text-pink-700" },
    Reference: { className: "bg-sky-100 text-sky-700" },
  },
  lens: {
    User: { className: "bg-[#426099] text-white" },
    Team: { className: "bg-slate-200 text-slate-700" },
    AI: { className: "bg-indigo-100 text-indigo-700" },
    Brand: { className: "bg-rose-100 text-rose-700" },
    Market: { className: "bg-amber-100 text-amber-700" },
    Product: { className: "bg-emerald-100 text-emerald-700" },
    Space: { className: "bg-teal-100 text-teal-700" },
    Operation: { className: "bg-zinc-200 text-zinc-700" },
  },
  question: {
    Why: { className: "bg-orange-100 text-orange-700" },
    What: { className: "bg-slate-100 text-slate-700" },
    How: { className: "bg-cyan-100 text-cyan-700" },
    When: { className: "bg-amber-100 text-amber-700" },
    Where: { className: "bg-teal-100 text-teal-700" },
    Who: { className: "bg-blue-100 text-blue-700" },
  },
};
